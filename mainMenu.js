...
BasicGame.MainMenu.prototype = {
  ...
  create: function () {
    ...
    this.add.text(this.game.width / 2, this.game.height - 90, "image assets by hiddenone, Enterbrain and WolfMountainGames", { font: "12px monospace", fill: "#fff", align: "center"}).anchor.setTo(0.5, 0.5);
